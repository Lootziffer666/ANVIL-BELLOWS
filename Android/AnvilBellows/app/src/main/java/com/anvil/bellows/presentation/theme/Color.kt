...
// ── IIG Core Palette (raw) ─────────────────────────────────
// Exact values used in icon generation and standalone UI elements.
val IigAnthracite        = Color(0xFF1A1916)  // Charcoal Room background
val IigOxidrot           = Color(0xFF8C2A16)  // Forge oxidrot (seal ring)
val IigAmber             = Color(0xFFC48018)  // Forge amber glow
val IigCream             = Color(0xFFEEE4D2)  // Warm Paper highlight

// ── Compatibility aliases ──────────────────────────────────
// Semantic names referenced in existing screens; map to IIG equivalents.
/** Availability indicator — maps to IIG success (sage green). */
val BabuTeal             = IigSuccessDark
